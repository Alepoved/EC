...
void button_ISR(void)
{
	...
	rEXTINTPND |= (buttons << 2);//ni
	ic_cleanflag(INT_EINT4567);//eint4567 invoca funcion buttons_isr.BORRAR FLAG INTERRUPCION
